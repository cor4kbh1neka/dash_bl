        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->usergroup }}</span></td>
                    <td><span class="name">{{ $d->useragent }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-players').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/players/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/players/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-players').on('click', '#add-players', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/players/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/players/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/players/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/players/delete');
        //     });
        // })



        $(document).on('click', '#delete-players', function(event) {
            event.preventDefault();
            ...
            var url =
                "/players/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/players/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/players/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/players/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/players/edit/' + id);
            });
        });
