...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-agents').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/agents/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/agents/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-agents').on('click', '#add-agents', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/agents/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/agents/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/agents/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/agents/delete');
        //     });
        // })



        $(document).on('click', '#delete-agents', function(event) {
            event.preventDefault();
            ...
            var url =
                "/agents/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/agents/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/agents/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/agents/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/agents/edit/' + id);
            });
        });
