        ...
        <div class="sechistoryds">
            <div class="grouphistoryds">
                <div class="groupheadhistoryds">
                    <div class="listmembergroup historytransds">
                ...
                <div class="tabelproses">
                    <table>
                        <tbody>
                            ...
                            <tr class="statusketerangan" data-status="deposit">
                                <td>
                                ...
                                <td>deposit</td>
                                <td>deposit</td>
                                <td class="debit nominal" data-value="0"></td>
                                <td class="credit nominal" data-value="100000"></td>
                                <td class="ttlbalance nominal" data-value="100000.67"></td>
                            </tr>
                            <tr class="statusketerangan" data-status="withdraw">
                                <td>
                                ...
                                <td>withdraw</td>
                                <td>withdraw</td>
                                <td class="debit nominal" data-value="30000.13"></td>
                                <td class="credit nominal" data-value="0"></td>
                                <td class="ttlbalance nominal" data-value="0.67"></td>
                            </tr>
                            <tr class="statusketerangan" data-status="manual">
                                <td>
                                    <div class="statusmember">3</div>
                                </td>
                                <td>4653765</td>
                                <td>2024-04-05 21:09:03</td>
                                <td>deposit manual</td>
                                <td>manual</td>
                                <td class="debit nominal" data-value="0"></td>
                                <td class="credit nominal" data-value="30000"></td>
                                <td class="ttlbalance nominal" data-value="30000.80"></td>
                            </tr>
                            <tr class="statusketerangan" data-status="manual">
                                <td>
                                ...
                                <td>4653765</td>
                                <td>2024-04-05 21:09:03</td>
                                <td>withdraw manual</td>
                                <td>manual</td>
                                <td class="debit nominal" data-value="5000"></td>
                                <td class="credit nominal" data-value="0"></td>
                                <td class="ttlbalance nominal" data-value="0.80"></td>
                            </tr>
                            <tr class="statusketerangan" data-status="menang">
                                <td>
                                ...
                                <td>menang</td>
                                <td class="debit nominal" data-value="0"></td>
                                <td class="credit nominal" data-value="5000"></td>
                                <td class="ttlbalance nominal" data-value="5000.80"></td>
                            </tr>
                            <tr class="statusketerangan" data-status="pemasangan">
                                <td>
                                ...
                                <td>pemasangan</td>
                                <td class="debit nominal" data-value="2500"></td>
                                <td class="credit nominal" data-value="0"></td>
                                <td class="ttlbalance nominal" data-value="0.80"></td>
                            </tr>
                            <tr class="statusketerangan" data-status="referral">
                                <td>
                                ...
                                <td>
                                    <a href="/referralds/bonusreferral?games=all%20games?datefrom=2024-04-17?dateto=2024-04-17?statusdp=aktif?upline=lontong6969" target="_blank" class="detailbetingan">
                                        <span class="texttypebet sportsType">Bonus</span>
                                        <span class="klikdetail"> - <span class="statustransaksi"></span></span>
                                    </a>
                                </td>
                                <td>pemasangan</td>
                                <td class="debit nominal" data-value="0"></td>
                                <td class="credit nominal" data-value="2500"></td>
                                <td class="ttlbalance nominal" data-value="2500.80"></td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".nominal").each(function(){
                ...
                var formattedNominal = parseFloat(nominal).toLocaleString('en', {maximumFractionDigits: 2});
