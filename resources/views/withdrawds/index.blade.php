    ...
    <div class="sec_table">
        ...
        <div class="secdepositds">
            <div class="groupdatamaster">
                ...
                <form id="form-withdrawds" method="POST" action="" class="tabelproses">
                    @csrf
                    <table>
                        <tbody>
                            <tr class="hdtable">
        ...
        $(document).ready(function() {
            $('#approve').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#form-withdrawds').attr('action', '/approve/WD');
                        $('#form-withdrawds').submit();
                    }
                });
            });
            ...
            $(document).on('click', '#reject', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#form-withdrawds').attr('action', '/reject/WD');
                        $('#form-withdrawds').submit();
                    }
                });
            });
