...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-transactions').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/transactions/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/transactions/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-transactions').on('click', '#add-transactions', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/transactions/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/transactions/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/transactions/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/transactions/delete');
        //     });
        // })



        $(document).on('click', '#delete-transactions', function(event) {
            event.preventDefault();
            ...
            var url =
                "/transactions/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/transactions/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/transactions/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/transactions/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/transactions/edit/' + id);
            });
        });
