                ...
                <div class="groupplayerinfo">
                    <div class="listgroupplayerinfo left">
                        <div class="listplayerinfo">
                            <label for="agentname">user agent</label>
                            <div class="groupeditinput">
                                <input type="text" id="agentname" name="agentname" value="" placeholder="masukkan nama agent">
                            </div>
                        </div>
                        <div class="listplayerinfo">
                            <label for="password">password</label>
                            <div class="groupeditinput">
                                <input type="password" id="password" name="password" value="" placeholder="input password agent">
                        ...
                        <div class="listplayerinfo">
                            ...
                            <div class="groupeditinput">
                                <input type="password" id="repassword" name="repassword" value="" placeholder="input password agent">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M12 9a3 3 0 0 1 3 3a3 3 0 0 1-3 3a3 3 0 0 1-3-3a3 3 0 0 1 3-3m0-4.5c5 0 9.27 3.11 11 7.5c-1.73 4.39-6 7.5-11 7.5S2.73 16.39 1 12c1.73-4.39 6-7.5 11-7.5M3.18 12a9.821 9.821 0 0 0 17.64 0a9.821 9.821 0 0 0-17.64 0" />
                                </svg>
                            </div>
                        ...
                        <div class="listplayerinfo">
                            ...
                            <select id="accesstype" name="accesstype">
                                <option value="leader">Leader - Access</option>
                                <option value="cs">CS - Access</option>
                                <option value="admin">Admin - Access</option>
                                <option value="marketing">Marketing - Access</option>
                                <option value="mt">MT - Access</option>
                            </select>
                        </div>
                    </div>
        ...
        $(document).ready(function(){
            $('.listplayerinfo svg').click(function(){
                ...
                if(inputField.attr('type') === 'password') {
                    ...
                    $(this).html('<path fill="currentColor" d="M2 5.27L3.28 4L20 20.72L18.73 22l-3.08-3.08c-1.15.38-2.37.58-3.65.58c-5 0-9.27-3.11-11-7.5c.69-1.76 1.79-3.31 3.19-4.54zM12 9a3 3 0 0 1 3 3a3 3 0 0 1-.17 1L11 9.17A3 3 0 0 1 12 9m0-4.5c5 0 9.27 3.11 11 7.5a11.8 11.8 0 0 1-4 5.19l-1.42-1.43A9.86 9.86 0 0 0 20.82 12A9.82 9.82 0 0 0 12 6.5c-1.09 0-2.16.18-3.16.5L7.3 5.47c1.44-.62 3.03-.97 4.7-.97M3.18 12A9.82 9.82 0 0 0 12 17.5c.69 0 1.37-.07 2-.21L11.72 15A3.064 3.064 0 0 1 9 12.28L5.6 8.87c-.99.85-1.82 1.91-2.42 3.13"/>');
                } else {
                    inputField.attr('type', 'password');
                    $(this).html('<path fill="currentColor" d="M12 9a3 3 0 0 1 3 3a3 3 0 0 1-3 3a3 3 0 0 1-3-3a3 3 0 0 1 3-3m0-4.5c5 0 9.27 3.11 11 7.5c-1.73 4.39-6 7.5-11 7.5S2.73 16.39 1 12c1.73-4.39 6-7.5 11-7.5M3.18 12a9.821 9.821 0 0 0 17.64 0a9.821 9.821 0 0 0-17.64 0"/>');
                }
            });
        });
    </script>
