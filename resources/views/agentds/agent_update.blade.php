                    ...
                    <div class="listgroupplayerinfo left">
                        <div class="listplayerinfo">
                            ...
                            <div class="groupeditinput">
                                <input type="text" readonly id="agentname" name="agentname" value="adminIT">
                        ...
                        <div class="listplayerinfo">
                            ...
                            <div class="groupeditinput">
                                <input type="newpassword" id="newpassword" name="newpassword" value="" placeholder="input password agent">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                        ...
                        <div class="listplayerinfo">
                            ...
                            <select id="accesstype" name="accesstype">
                                ...
                                <option value="admin" selected>Admin - Access</option>
