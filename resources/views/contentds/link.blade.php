                        ...
                        <table id="sortable-table">
                            <tbody>
                                ...
                                <tr class="dinamicrow">
                                    ...
                                    <td class="datamini">link alternatif 1</td>
                                    <td class="datamini">https://www.loremipsum.com</td>
                                    <td class="statuspromo" data-status="1"></td>
                                    <td>
                                        <div class="grouptools">
                                            <a href="/contentds/link/edit" target="_blank" class="tombol grey openviewport">
                                ...
                                <tr class="dinamicrow">
                                    ...
                                    <td class="datamini">link alternatif 2</td>
                                    <td class="datamini">https://www.loremipsum.com</td>
                                    <td class="statuspromo" data-status="1"></td>
                                    <td>
                                        <div class="grouptools">
                                ...
                                <tr class="dinamicrow">
                                    ...
                                    <td class="datamini">link alternatif 3</td>
                                    <td class="datamini">https://www.loremipsum.com</td>
