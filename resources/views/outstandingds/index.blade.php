...
@section('container')
    ...
    <div class="sec_table">
        <div class="secgrouptitle">
            <h2>{{ $title }}</h2>
            <span class="countpendingdata outstanding">40</span>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="groupcountout">
                                            <span class="countdataout">8</span>
                                            <span class="selengkapnyaout">
                                                ( Lihat 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="groupcountout">
                                            <span class="countdataout">2</span>
                                            <span class="selengkapnyaout">
                                                ( Lihat 
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 1024 1024">
                                                    <path fill="currentColor" d="M754.752 480H160a32 32 0 1 0 0 64h594.752L521.344 777.344a32 32 0 0 0 45.312 45.312l288-288a32 32 0 0 0 0-45.312l-288-288a32 32 0 1 0-45.312 45.312z" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="groupcountout">
                                            <span class="countdataout">10</span>
                                            <span class="selengkapnyaout">
                                                ( Lihat 
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 1024 1024">
                                                    <path fill="currentColor" d="M754.752 480H160a32 32 0 1 0 0 64h594.752L521.344 777.344a32 32 0 0 0 45.312 45.312l288-288a32 32 0 0 0 0-45.312l-288-288a32 32 0 1 0-45.312 45.312z" />
