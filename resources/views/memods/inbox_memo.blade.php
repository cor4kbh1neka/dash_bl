        ...
        <div class="secmemods">
            <div class="groupsecmemods">
                <div class="headgroupsecmemods">
                    ...
                    <a href="/memods/viewinbox" class="tombol grey active">
                        ...
                        <div class="tabelproses">
                            <table>
                                <tbody>
                                    ...
                                    <tr class="dataxstatus" data-status="0"> <!-- data-status mempengaruhi read/unread, javascript di bagian bawah sudah handle untuk print text class="xstatus" dan warna baris -->
                                        <td>1</td>
                                        <td>MS000001</td>
                                        <td>thanos989898</td>
                                        <td>628123456789</td>
                                    ...
                                    <tr class="dataxstatus" data-status="0">
                                        <td>2</td>
                                        <td>MS000002</td>
                                        <td>thanos989898</td>
                                        <td>628123456789</td>
