    ...
    <div class="body_openwindow feedback">
        <div class="sec_openwindow">
            <div class="headfeedback">
                <span class="namauser">Message - DV000001</span>
            </div>
            <div class="datainbox">
                <div class="detailfeedback">
                    ...
                    <div class="listdetailfeedback">
                        ...
                        <span class="gap">:</span>
                        <div class="valuedetail">to user</div>
                    </div>
                    <div class="listdetailfeedback">
                    ...
                    <div class="listdetailfeedback">
                        ...
                        <span class="gap">:</span>
                        <div class="valuedetail">BANK BCA</div>
                    </div>
                    <div class="listdetailfeedback top">
                        <div class="labeldetail">memo</div>
                        <span class="gap">:</span>
                        <div class="valuedetail">Kami ingin memberitahukan kepada semua pelanggan setia kami bahwa mulai tanggal 24 April 2024 kami akan melakukan pergantian rekening bank BCA untuk proses pembayaran. Mohon selalu lakukan cek rekening aktif terbaru kami sebelum melakukan transfer dana.</div>
                    </div>
                </div>
