...
@section('container')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-allowedip').off('click').click(function(event) {
                ...
                $('.aplay_code').load('/allowedip/edit/' + parameterString, function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/allowedip/edit/' +
                        parameterString);
                });
            });


            $(document).off('click', '#add-allowedip').on('click', '#add-allowedip', function(event) {
                event.preventDefault();
                $('.aplay_code').load('/allowedip/add', function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/allowedip/add');
                });
            });
            // $(document).on('click', '#delete', function(event) {
            //     event.preventDefault();
            //     $('.aplay_code').load('/allowedip/delete', function() {
            //         adjustElementSize();
            //         localStorage.setItem('lastPage', '/allowedip/delete');
            //     });
            // })



            $(document).on('click', '#delete-allowedip', function(event) {
                event.preventDefault();
                ...
                var url =
                    "/allowedip/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
            ...
            $(document).off('click', '#view').on('click', '#view', function(event) {
                ...
                var id = $(this).data('id');
                $('.aplay_code').empty();
                $('.aplay_code').load('/allowedip/view/' + id, function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/allowedip/view/' + id);
                });
            });
            ...
            $(document).off('click', '#edit').on('click', '#edit', function(event) {
                ...
                var id = $(this).data('id');
                $('.aplay_code').empty();
                $('.aplay_code').load('/allowedip/edit/' + id, function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/allowedip/edit/' + id);
                });
            });
